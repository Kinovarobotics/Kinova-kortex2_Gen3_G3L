...
|SetPartNumberRevision|None|[PartNumberRevision](msg_DeviceConfig_PartNumberRevision.md#)|Sets the device part number revision \(intented for Kinova Production\) \(future\)|
