...
private:
    ...
    k_api::InterconnectConfig::InterconnectConfigClient* interconnect_config_;
    k_api::DeviceManager::DeviceManagerClient* device_manager_;
...
public:
    ...
    k_api::DeviceManager::DeviceManagerClient* getDeviceManager() const;
      

    k_api::InterconnectConfig::InterconnectConfigClient* getInterconnectConfig() const;
