...
This page describes the C++ Kinova::Api::Base::MapHandle message.
...
|permission|uint32|Permission of specified map entity. Must use 'Kinova.Api.Common.Permission' enum.|
