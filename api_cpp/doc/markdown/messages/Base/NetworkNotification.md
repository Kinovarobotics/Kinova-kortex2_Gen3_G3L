...
|user\_handle| [UserProfileHandle](../Common/UserProfileHandle.md#)|User that caused the network event to occur|
|connection| [Connection](../Common/Connection.md#)|Connection that caused the network event to occur|
