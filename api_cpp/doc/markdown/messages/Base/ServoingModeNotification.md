...
|-----------|---------|-----------|
|servoing\_mode|uint32|New servoing mode|
|timestamp| [Timestamp](../Common/Timestamp.md#)|Event timestamp|
|user\_handle| [UserProfileHandle](../Common/UserProfileHandle.md#)|User that caused the servoing mode event|
|connection| [Connection](../Common/Connection.md#)|Connection that caused the servoing mode event|
